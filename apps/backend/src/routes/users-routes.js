...
import { signUp, loginGenerateOtp, passwordResetGenertor, loginOtp, passwordReset, 
// callbackGoogleAuth,
failedgoogleauth, successgoogleauth, getAllUsers, editUser, } from '../controllers/user.controller';
...
router.get('/callbackgoogleauth', passport.authenticate('google', {
